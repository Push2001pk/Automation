...
public class independent_And_Dependent 
{
   public static void main(String[] args) 
   {
	String priceOfProduct="65,999";
	String productName="APPLE iPhone 14 Plus (Blue, 128 GB)";
	
	ChromeDriver driver=new ChromeDriver();
	driver.manage().window().maximize();
	driver.get("https://www.flipkart.com/search?q=i%20phone&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off");
